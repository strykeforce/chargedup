...
public class Calibrate3dPipeTest {
    ...
    @Test
    public void calibrateSquares1280x800_pi() {
        String base = TestUtils.getSquaresBoardImagesPath().toAbsolutePath().toString();
        File dir = Path.of(base, "piCam", "1280_800_1").toFile();
        Size sz = new Size(1280, 800);
        calibrateSquaresCommon(sz, dir);
    }
    ...
    public void calibrateSquaresCommon(Size imgRes, File rootFolder, Size boardDim) {
        calibrateSquaresCommon(
                imgRes, rootFolder, boardDim, Units.inchesToMeters(2.3), imgRes.width / 2, imgRes.height / 2);
    }
    ...
    public void calibrateSquaresCommon(
        ...
        calibrateSquaresCommon(
                imgRes, rootFolder, boardDim, Units.inchesToMeters(2.3), expectedXCenter, expectedYCenter);
    }
