...
public class TwoPieceWithDockAutoCommandGroup extends SequentialCommandGroup {
  ...
  public TwoPieceWithDockAutoCommandGroup(DriveSubsystem driveSubsystem, RobotStateSubsystem robotStateSubsystem, ArmSubsystem armSubsystem, HandSubsystem handSubsystem, IntakeSubsystem intakeSubsystem, String pathOne, String pathTwo, String pathThree) {
