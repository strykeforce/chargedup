...
public class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kMaxSpeedMetersPerSecond = 3.889; // 5.121; // practice bot 3.889
    public static final double kRobotWidth = 0.625; // 0.5; // practice bot: 0.625
    public static final double kRobotLength = 0.625; // 0.615; // practice bot: 0.625
    ...
    // From: https://github.com/strykeforce/axis-config/
    static final double kDriveMotorOutputGear = 22; // 30; // practice bot: 22
