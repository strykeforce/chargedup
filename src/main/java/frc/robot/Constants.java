...
public class Constants {
  ...
  public static final class RobotStateConstants {
    ...
    public static final Pose2d kCubeFourAutoPickup =
        new Pose2d(new Translation2d(7.07, 4.58), new Rotation2d());
  ...
  public static class CompConstants {
    ...
    // Elbow
    public static final int kElbowZeroTicks = 700; // 705
    ...
    // Intake
    public static final int kIntakeZeroTicks = 2_900; // 2440 ->2540
