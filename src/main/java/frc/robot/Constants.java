...
public class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kHoldSpeed = 0.25;
  ...
  public static final class ElbowConstants { // FIXME needs real tick values
    ...
    public static final int kReverseSoftLimit = -48_000; // -44_847
    ...
    public static final double kIntakeElbow = -44_800; // -43_600
  ...
  public static class CompConstants {
    ...
    // Elbow
    public static final int kElbowZeroTicks = 1194; // 730 ANGLE:2deg in
